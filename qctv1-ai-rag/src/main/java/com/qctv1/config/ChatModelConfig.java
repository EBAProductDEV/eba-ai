...
public class ChatModelConfig {
    ...
    public ChatModel dashScopeQwenModel() {
        return DashScopeChatModel.builder()
                .dashScopeApi(DashScopeApi.builder().apiKey(System.getenv("QCTV1_AI_API_KEY")).build())
                .defaultOptions(DashScopeChatOptions.builder().model("qwen1.5-110b-chat").build())
                .build();
    }
}
